sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("generated.app.controller.master_page_1", {
	...
	_onListItemPress: function (oEvent) {
		...
		return new ES6Promise.Promise(function(resolve, reject) {
		    ...
		    this.doNavigate("detail_page_1", oBindingContext, resolve, ""
		    );
		}.bind(this));
	...
	onInit: function () {
        ...
        this.oRouter.getTarget("master_page_1").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
