sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    return BaseController.extend("generated.app.controller.detail_page_1", {
	...
	_onListItemPress1: function (oEvent) {
		...
		return new ES6Promise.Promise(function(resolve, reject) {
		    ...
		    this.doNavigate("detail_page_2", oBindingContext, resolve, ""
		    );
		}.bind(this));
	...
	onInit: function () {
        ...
        this.oRouter.getTarget("detail_page_1").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
                ...
                if (sap.ui.Device.system.phone) {
                    ...
                    if (oPage.getShowNavButton && ! oPage.getShowNavButton()) {
                        ...
                        oPage.attachNavButtonPress(function () {
                            this.oRouter.navTo("master_page_1", {}, true);
                        }.bind(this));
                    }
                }
            }.bind(this)
